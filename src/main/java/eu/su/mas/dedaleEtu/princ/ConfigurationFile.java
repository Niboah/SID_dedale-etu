...
/**
 * Configuration file for a Dedale instance 1) Network and platform parameters
...
public final class ConfigurationFile {
	...
	// public static String
	// INSTANCE_TOPOLOGY="resources/topology/map2021-topologyExam1-graph.dgs";
	...
	public static Integer OPTIONAL_ADDITIONAL_ENVGENERATOR_PARAM1 = 1;// used by the BARABASI_ALBERT generator to know
	...
	// public static String
	// INSTANCE_CONFIGURATION_ENTITIES="resources/agentExplo-2";
	// public static String
	// INSTANCE_CONFIGURATION_ENTITIES="resources/agentExploCoop-2";
	public static String
