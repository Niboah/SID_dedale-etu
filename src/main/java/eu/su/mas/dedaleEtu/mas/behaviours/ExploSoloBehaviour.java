 ...
 * The algorithm is a pseudo - DFS computationally consuming because it's not optimised at all.</br>
 * <p>
 * When all the surrounding nodes are visited, the agent randomly select an open node and go there to restart its dfs.</br>
        ...
        if (myPosition != null) {
            ...
            if (this.openNodes.isEmpty()) {
                ...
                if (b) {
                    ...
                    System.out.println(this.myAgent.getLocalName() + " - My current backpack capacity is:" + ((AbstractDedaleAgent) this.myAgent).getBackPackFreeSpace());
                    System.out.println(this.myAgent.getLocalName() + " - The agent tries to transfer is load into the Silo (if reachable); success ? : " + ((AbstractDedaleAgent) this.myAgent).emptyMyBackPack("Silo"));
                    System.out.println(this.myAgent.getLocalName() + " - My current backpack capacity is:" + ((AbstractDedaleAgent) this.myAgent).getBackPackFreeSpace());
                }
