...
public class Agent_Final extends AbstractDedaleAgent {
    ...
    public class InitBehaviour  extends Behaviour {
        ...
        public void linkAgentBDI(Agent_Final agent){
        ...
        public void updateAgentList(Agent_Final agent){
            DFAgentDescription template = new DFAgentDescription();
            ServiceDescription templateSd = new ServiceDescription();
    ...
    public class ImReadyBehaviour extends Behaviour{
        ...
        @Override
        public void action() {
            String currentPosition = ((Agent_Final)myAgent).getCurrentPosition().toString();
        ...
        public boolean done() {
            if(finish){
                switch (((Agent_Final)myAgent).type){
                    case "AgentExplo":
        ...
        public void action() {
            ...
            if (requestMenssage != null) {
                if (requestMenssage.getContent() != null) {
                    ...
                    List<String> path =  map.getShortestPath(((Agent_Final)myAgent).getCurrentPosition().toString(),content);
    ...
    public class GoPosBehaviour extends Behaviour{
        ...
        public void observe(Agent_Final agent, String myPosition){
            String content="";
    ...
    public class RecibeMenssageBehaviour extends CyclicBehaviour{
        ...
        public void action() {
            ...
            MessageTemplate msgTemplate = MessageTemplate.not( MessageTemplate.or(shareMapTemplate,requestTemplate));
